<div class="ms_sidemenu_wrapper">
            ...
            <div class="ms_sidemenu_inner">
                <div class="ms_logo_inner">
                    <div class="ms_logo">
                        <a href="dashboard.php"><img src="images/loh.png" alt="" class="img-fluid"/></a>
                    </div>
                ...
                <div class="ms_nav_wrapper">
                    <ul>
                        <li><a href="dashboard.php" class="active" title="Discover">
						<span class="nav_icon">
                    ...
                    <ul class="nav_downloads">
                        ...
                        <li><a href="track_buy_play.php" title="Purchased">
						<span class="nav_icon">
                        ...
                        <li><a href="profile.php" title="History">
						<span class="nav_icon">
                    ...
                    <ul class="nav_playlist">
                        <li><a href="track_desc.php" title="Featured Playlist">
						<span class="nav_icon">
                        ...
                        <li><a href="add_track.php" title="Create Playlist">
						<span class="nav_icon">
