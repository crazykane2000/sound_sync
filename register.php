...
<body style="background-image: url('images/pokl.jpg');">
    ...
    <center><a href="index.php"><img src="images/soun.png" style="width: 180px"></center></a><div style="padding: 10px;"></div>
     <div style="padding: 40px;background-color: #07163f;width: 300px;margin:0 auto">
        ...
        <div class="row">
          <div class="col-sm-12">
            <input type="text" class="form-control inputs" name="user" placeholder="Enter Full Name">
              <input type="hidden" name="role" value="User-Agent-x">
            <div id="email_error" style="color: red;font-size: 12px;display: none;">Enter Full</div>
            <div style="padding: 4px;" class="mobs"></div>
            <input type="text" class="form-control inputs" name="user" placeholder="Enter Email Address">

            <div style="padding: 4px;" class="mobs"></div>
            <input type="text" class="form-control inputs" name="user" placeholder="Enter Organization Name">

            <div style="padding: 4px;" class="mobs"></div>
            <input type="text" class="form-control inputs" name="user" placeholder="Enter Password">
        ...
        <div class="row">
           ...
           <div class="col-sm-12">
             <input type="password" class="form-control inputs" name="pass" placeholder="Reenter Password">
